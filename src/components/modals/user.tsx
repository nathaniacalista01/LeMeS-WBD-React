...
export function EditUserModal({
    ...
    useEffect(() => { // Fetch Data to Get User Detail
        const fetchData = async () => {
            try {
                setIsLoading(true);
                const res = await newAxiosInstance.get(`${config.REST_API_URL}/user/${user_id}`);
    ...
    const handleEditUser = async () => {
        try {
            setIsLoading(true);
            const response = await newAxiosInstance.put(`${config.REST_API_URL}/user/${user_id}`, {
                username: username,
                fullname: fullname,
                role: role,
            });
...
export function DeleteUserModal({
    ...
    const handleDeleteUser = async () => {
        try {
            setIsLoading(true);
            const response = await newAxiosInstance.delete(`${config.REST_API_URL}/user/${user_id}`);
