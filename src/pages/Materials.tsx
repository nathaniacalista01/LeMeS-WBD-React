  ...
  const [module, setModule] = useState([
    {
      module_id: 1,
      title:
        "module a sasdasds asdaa sD asd asdasdadsadasfasdashasdsadasdasahdasdahahahaasdasdassfasdasdahahdasdasdasdasdsahhaakasiandehlosemuanyasssssdasd asdasd asd assfasdasasdas ddasd asd d1asd as",
    },
                      ...
                      <Tr key={item.module_id}>
                        ...
                        <Td width="5%" p="2">
                          <Icon
                            ...
                            cursor={"pointer"}
                            onClick={() =>
                              openModalEdit(item.module_id, item.title)
                            }
                          ></Icon>
                          <Icon
                            as={BiSolidTrash}
